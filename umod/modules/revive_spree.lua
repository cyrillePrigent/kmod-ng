...
reviveSpree = {
    ["announceRevives"]         = tonumber(et.trap_Cvar_Get("k_announce_revives")),
    ["reviveColor"]             = et.trap_Cvar_Get("k_revive_color"),
    ["revivePosition"]          = et.trap_Cvar_Get("k_revive_pos"),
    ["reviveSpreePosition"]     = et.trap_Cvar_Get("k_revive_spree_pos"),
    ["reviveSpreeColor"]        = et.trap_Cvar_Get("k_revive_spree_color"),
    ["multiRevive"]             = tonumber(et.trap_Cvar_Get("k_multi_revive")),
    ["multiReviveAnnounce"]     = tonumber(et.trap_Cvar_Get("k_multi_revive_announce")),
    ["multiReviveSound"]        = tonumber(et.trap_Cvar_Get("k_multi_revive_sound")),
    ["multiRevivePosition"]     = et.trap_Cvar_Get("k_multi_revive_pos"),
    ["monsterRevivePosition"]   = et.trap_Cvar_Get("k_monster_revive_pos"),
    ["multiReviveMsg"]          = et.trap_Cvar_Get("k_multi_revive_msg"),
    ["monsterReviveMsg"]        = et.trap_Cvar_Get("k_monster_revive_msg"),
    ["multiReviveWithoutDeath"] = tonumber(et.trap_Cvar_Get("k_multi_revive_without_death")),
    ["allowTkRevive"]           = tonumber(et.trap_Cvar_Get("k_allow_tk_revive")),
    ["recordLastNick"]          = tonumber(et.trap_Cvar_Get("k_record_last_nick")),
    ["recordsExpire"]           = 60 * 60 * 24 * tonumber(et.trap_Cvar_Get("k_records_expire")),
    ["saveAwards"]              = tonumber(et.trap_Cvar_Get("k_save_awards")),
    ["srvRecord"]               = tonumber(et.trap_Cvar_Get("k_srv_record")),
    ["amount1"]                 = tonumber(et.trap_Cvar_Get("k_revivespree1_amount")),
    ["amount2"]                 = tonumber(et.trap_Cvar_Get("k_revivespree2_amount")),
    ["amount3"]                 = tonumber(et.trap_Cvar_Get("k_revivespree3_amount")),
    ["amount4"]                 = tonumber(et.trap_Cvar_Get("k_revivespree4_amount")),
    ["amount5"]                 = tonumber(et.trap_Cvar_Get("k_revivespree5_amount")),
    ["amount6"]                 = tonumber(et.trap_Cvar_Get("k_revivespree6_amount")),
    ["amount7"]                 = tonumber(et.trap_Cvar_Get("k_revivespree7_amount")),
    ["message1"]                = et.trap_Cvar_Get("k_rs_message1"),
    ["message2"]                = et.trap_Cvar_Get("k_rs_message2"),
    ["message3"]                = et.trap_Cvar_Get("k_rs_message3"),
    ["message4"]                = et.trap_Cvar_Get("k_rs_message4"),
    ["message5"]                = et.trap_Cvar_Get("k_rs_message5"),
    ["message6"]                = et.trap_Cvar_Get("k_rs_message6"),
    ["message7"]                = et.trap_Cvar_Get("k_rs_message7"),
    ["msgDefault"]              = tonumber(et.trap_Cvar_Get("k_msg_default")),
    ["maxSpree"]                = 0,
    ["maxId"]                   = nil,
    ["stats"]                   = {},
    ["mapRecord"]               = false,
